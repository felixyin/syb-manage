...
<div class="my-container"style="background-color: white">
  ...
  <div class="falv">
    <img src="/static/syb/images/chuangyedalibao.png">
    <div class="info">
      <h2>网络宣传推广大礼包 </h2>
      <div class="price">

        <b>优惠价</b>
        <strong id="price">49元</strong>

      </div>
      <div class="taocan">
        服务项目
        <button value="1" id="tc1" >标准套餐</button>
        <button value="0" id="tc0" >定制套餐</button>
      ...
      <div class="taocan">
        ...
        <button value="3" id="tcc">三年</button>
      </div>
      <div class="clearfix"></div>
      <div class="clearfix"></div>
      <div style="text-align: left;width: 550px;margin-top: 40px">
  ...
  <div class="my-dh" id="header">
    <a href="#1000"><div class="dg">内容介绍</div></a>
    <a href="#2000"><div class="dg">服务流程</div></a>
    <a href="#3000"><div class="dg">服务保障承诺</div></a>
  </div>
  <div class="my-cont">
    <div class="my-cont_1">
      <img id="1000" src="/static/syb/images/chuangyenr.png">
      <img src="/static/syb/images/wangzhan.png">
      <img src="/static/syb/images/sousuo.png">

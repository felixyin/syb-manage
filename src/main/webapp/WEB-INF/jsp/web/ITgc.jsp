...
<div class="my-container"style="background-color: white">
  ...
  <div class="falv">
    ...
    <div class="info">
      ...
      <div class="taocan">
        套餐
        <button value="1" id="tc1" >IT设备维护</button>
      ...
      <div class="clearfix"></div>
      <div style="text-align: left;width: 550px;margin-top: 0px">
  ...
  <div class="my-dh" id="header">
    <a href="#1000"><div class="dg">服务说明</div></a>
    <a href="#2000"><div class="dg">服务流程</div></a>
    <a href="#3000"><div class="dg">服务承诺</div></a>
  </div>
  <div class="my-cont">
    <div class="my-cont_1">

...
<div class="my-container" style="background-color: white">
  ...
  <div class="my-dh" style="width: 1050px;margin: 0px auto" id="header">
    <a>
      <div class="dg" style="background-color:#e5e5e5;width: 350px ">公司注册</div>
    </a>
    <a href="cai_shui.jsp#22">
      <div class="dg" style="width: 350px">记账代理</div>
    </a>
  ...
  <div class="main-container">
    <div class="head" id="11"><p style="letter-spacing: 6px">请选择您需要的<b>套餐</b></p></div>
    <div class="clearfix"></div>
      ...
      <div class="container">
        <div class="list">
          ...
          <div class="my-card huang-se" data-source-class="huang-se"
               data-target-class="huang-se-hover" data-fp="3600" id="list1">
            <div>
              <img src="/static/syb/images/jizhang.png">
              <div><strong>实地公司</strong><br>注册</div>
            </div>
            <div class="list-display">
              <!--<p>服务费=3000元<br>工本费=600元<br>3600元</p>-->
              <p>3600元</p>
            </div>
          </div>
          <div class="my-card huang-se" data-source-class="huang-se"
               data-target-class="huang-se-hover" data-value="600" id="list2">
            <div>
              <img src="/static/syb/images/jizhang.png">
              <div><strong>虚拟公司</strong><br>注册</div>
            </div>
            <div class="list-display">
              <!--<p>服务费=3000元<br>工本费=600元<br>3600元</p>-->
              <p>3600元</p>
          ...
          <div class="my-card huang-se" data-source-class="huang-se"
               data-target-class="huang-se-hover" data-value="8600" id="list3">
            <div>
              <img src="/static/syb/images/mingxizhang.png">
              <div><strong>自贸区公司</strong><br>注册</div>
            </div>
            <div class="list-display">
              <!--<p>服务费=3000元<br>工本费=600元<br>3600元</p>-->
              <p>8600元</p>
        ...
        <div class="list">
          <div class="my-right-list">
            ...
            <div class=" my-card lv-se" data-source-class="lv-se"
                 data-target-class="lv-se-hover" data-value="300" id="list4">
              <div>
                <img src="/static/syb/images/mingxizhang.png">
                <div><strong>小规模</strong></div>
              </div>
              <div class="list-display">
                300元/月
              </div>
            ...
            <div class="my-card lv-se" data-source-class="lv-se"
                 data-target-class="lv-se-hover" data-value="500" id="list5">
              <div>
                <img src="/static/syb/images/mingxizhang.png">
                <div><strong>一般规模</strong></div>
              </div>
              <div class="list-display">
                500元/月
              </div>
            ...
            <div class="my-card lv-se" data-source-class="lv-se"
                 data-target-class="lv-se-hover" data-value="0" id="list6">
              <div>
                <img src="/static/syb/images/mingxizhang.png">
                <div><strong>不需要</strong></div>
              </div>
              <div class="list-display">
                不需要
              </div>
        ...
        <div class="list">
          <div class="my-right-lis">
            ...
            <div class="lan-se my-card3" data-source-class="lan-se"
                 data-target-class="lan-se-hover" data-fp="50" id="list7">
              <div>
                <img src="/static/syb/images/fapiao.png">
                <div><strong>少于5人</strong><br>人事代缴</div>
              </div>
              <div class="list-display2">
                50元/人
                <input type="number" value="" class="my-inp">
              </div>
            </div>
            <div class=" lan-se my-card3" data-source-class="lan-se"
                 data-target-class="lan-se-hover" data-fp="40" id="list8">
              <div>
                <img src="/static/syb/images/fapiao.png">
                <div><strong>5到20人</strong><br>人事代缴</div>
              </div>
              <div class="list-display2">
                40元/人
                <input type="number" value="" class="my-inp">
            ...
            <div class=" lan-se  my-card3" data-source-class="lan-se"
                 data-target-class="lan-se-hover" data-fp="30" id="list9">
              <div>
                <img src="/static/syb/images/fapiao.png">
                <div><strong>20人以上</strong><br>人事代缴</div>
              </div>
              <div class="list-display2">
                30元/人
                <input type="number" class="my-inp" value="">
              </div>
            </div>
            <div class=" lan-se  my-card3" data-source-class="lan-se"
                 data-target-class="lan-se-hover" data-fp="0.0" id="list10">
              <div>
                <img src="/static/syb/images/fapiao.png">
                <div style="margin-top: 10px"><strong>不需要</strong></div>
              </div>
              <div class="list-display">
                不需要
              </div>
          ...
          <div class="list">
            <div class="my-right-lis">
              ...
              <div class=" zi-se my-card" data-source-class="zi-se"
                   data-target-class="zi-se-hover" data-cheng="0.0" id="list11">
                <div>
                  <img src="/static/syb/images/kuaiji.png">
                  <div style="margin-top: 10px"><strong>三个月</strong></div>
                </div>
                <div class="list-display">
                  新用户试用期
                </div>
              ...
              <div class="zi-se my-card" data-source-class="zi-se"
                   data-target-class="zi-se-hover" data-cheng="6" id="list12">
                <div>
                  <img src="/static/syb/images/kuaiji.png">
                  <div><strong>半年</strong><br>套餐服务</div>
                </div>
                <div class="list-display">
                  半年（原价）
                </div>
              ...
              <div class=" zi-se my-card" data-source-class="zi-se"
                   data-target-class="zi-se-hover" data-cheng="11.4" id="list13">
                <div>
                  <img src="/static/syb/images/kuaiji.png">
                  <div><strong>一年</strong><br>套餐服务</div>
                </div>
                <div class="list-display">
                  一年(9.5折)
                </div>
              ...
              <div class=" zi-se my-card" data-source-class="zi-se"
                   data-target-class="zi-se-hover" data-cheng="28.8" id="list14">
                <div>
                  <img src="/static/syb/images/kuaiji.png">
                  <div><strong>三年</strong><br>套餐服务</div>
                </div>
                <div class="list-display">
                  三年(8.5折)
                </div>

...
<div class="login-page">
  ...
  <div class="mmain" style="background-image: url(/static/syb/images/login_bg.png)">
    <div class="card">
      <ul>
        <li id="shouji">手机登录</li>
        <div></div>
        <li id="youxiang">邮箱登录</li>
      </ul>
      <form id="em">
        ...
        <P>
          ...
          <label style="padding: 0">两周内自动登录</label>
          <label><a hidden="toregister.do">找回密码</a></label>
        </P>

...
<div class="my-container" style="background-color: white">
  ...
  <div class="falv">
    ...
    <img src="${subMenu.logo}">
    <div class="info">
      <h2>${subMenu.name}</h2>
      <div class="price">
        <b>优惠价</b>
        <strong>${subMenu.new_price}</strong>
      </div>
      <div class="taocan">
        套餐
        <button value="1" id="tca">套餐一</button>
        <button value="2" id="tcb">套餐二</button>
        <button value="4" id="tcc">套餐三</button>
      </div>
      <div class="taocan">
        <button value="2" id="tc2">请咨询客服</button>
      </div>
  ...
  <div class="my-cont">
    <div class="my-cont_1">
      <img id="1000" src="${subMenu.service_content}">
      <img id="2000" src="${subMenu.service_process}">
      <img id="3000" src="${subMenu.service_promise}">
    </div>
  </div>

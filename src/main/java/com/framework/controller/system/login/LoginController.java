package com.framework.controller.system.login;
...
import com.framework.entity.Result;
...
import com.framework.entity.system.Menu;
import com.framework.entity.system.Role;
import com.framework.entity.system.User;
import com.framework.service.system.menu.MenuService;
import com.framework.service.system.role.RoleService;
...
import com.framework.util.RightsHelper;
...
//            String code = KEYDATA[2];
        ...
        if (Tools.notEmpty(sessionCode) /*&& sessionCode.equalsIgnoreCase(code)*/) {
            ...
            if (pd != null) {
                ...
                BizUser bizUser = userService.getBizUserByUserId(pd.getString("USER_ID"));
                session.setAttribute(Const.SESSION_USER, user);
                session.setAttribute(Const.SESSION_BIZ_USER, bizUser);
...
//        }
    ...
    @ResponseBody
    public Object singleCheck() throws Exception {
        ...
        boolean b = userService.singleCheck(pd);
        if (b) {
            result.setCode(1);
        }
        return result;
    ...
    public Object register() throws Exception {
        ...
        boolean check = userService.checkUserByNamePhoneEmail(pd);

        if (check) {
            boolean b = userService.saveUser(pd);
            return b ? new Result(1, "成功", null) : new Result(0, "失败", null);
        } else {
            return new Result(0, "非法操作", null);
        }

package com.framework.controller.system.user;
...
import com.framework.util.FileDownload;
import com.framework.util.FileUpload;
import com.framework.util.GetPinyin;
import com.framework.util.Jurisdiction;
import com.framework.util.ObjectExcelRead;
import com.framework.util.PageData;
import com.framework.util.ObjectExcelView;
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			...
			for(int i=0;i<listPd.size();i++){		
				...
				pd.put("PASSWORD", new SimpleHash("SHA-1", "123", "123").toString());	//默认密码123
				if(userService.findByUN(pd) != null){
					continue;
				}
